...
def attiva(comando,forza):
    ...
    if comando=="attivavideo":
        ...
        esegui("https://60d0415d529b950c1b4047d9.connect.athom.com/api/app/com.internet/ipcamvalme/ON")
...
"""
    if comando=="attivaimmagine" and datetime.datetime.now().month == 7:
        ...
        esegui("https://60d0415d529b950c1b4047d9.connect.athom.com/api/app/com.internet/ipcamvalme/OFF")
...
"""
        ...
        f.close
        esegui("https://60d0415d529b950c1b4047d9.connect.athom.com/api/app/com.internet/ipcamvalme/OFF")
        esegui("https://maker.ifttt.com/trigger/control_nsvalme/with/key/cJSX_GyJ6VIECJvK6c4Eap?value1=Attiva%20Immagine%20(Agosto)")
        return """
<div align="center">
<p></p>
<center>
...
"""
        ...
        if forza == "yes":
            f.write("forza/n")
        f.close
        esegui("https://maker.ifttt.com/trigger/control_nsvalme/with/key/cJSX_GyJ6VIECJvK6c4Eap?value1=Attiva%20Immagine")
        esegui("https://60d0415d529b950c1b4047d9.connect.athom.com/api/app/com.internet/ipcamvalme/OFF")
        return """
<div align="center">
<p></p>
