...
nometipo1=["drive","tipofile","Video","tipo","Collana","Versione","campo1","campo2","campo3","campo4","campo5","campo6","campo7","NomeFile","data_modifica","data_accesso","data_creazione","dimensione","durata"]
    ...
    for file in filenames:
        if file[-4:] != ".ele":
            ...
            if debug:
                ...
                print(campi)
                a=input(file)
            for elementi in range (len(campi), 13):
                campi.append("N/A")
            campi.append (file)
